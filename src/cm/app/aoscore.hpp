...
private:
    ...
    aos::spaceallocator::SpaceAllocator<2 * cMaxNumUpdateImages> mDownloadSpaceAllocator;
    aos::spaceallocator::SpaceAllocator<2 * cMaxNumUpdateImages> mInstallSpaceAllocator;
