...
#ifndef AOS_CM_COMMUNICATION_TESTS_STUBS_CONNECTIONSUBSCRIBER_HPP_
#define AOS_CM_COMMUNICATION_TESTS_STUBS_CONNECTIONSUBSCRIBER_HPP_
 ...
 */
class ConnectionSubscriberStub : public cloudconnection::ConnectionListenerItf {
public:
