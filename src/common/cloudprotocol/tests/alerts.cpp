...
TEST_F(CloudProtocolAlerts, AlertsArray)
{
    constexpr auto cJSON
        = R"({"messageType":"alerts","correlationId":"id","items":[)"
          R"({"timestamp":"1970-01-01T00:00:00.000000Z","tag":"coreAlert","node":{"codename":"test_node"},)"
          R"("coreComponent":"CM","message":"Test core alert message"},)"
          R"({"timestamp":"1970-01-01T00:00:00.000000Z","tag":"resourceAllocateAlert","item":{"id":"itemID"},)"
          ...
          R"({"timestamp":"1970-01-01T00:00:00.000000Z","tag":"downloadProgressAlert","digest":"testDigest",)"
          ...
          R"({"timestamp":"1970-01-01T00:00:00.000000Z","tag":"instanceQuotaAlert","item":{"id":"itemID"},)"
          R"("subject":{"id":"subjectID"},"instance":1,"parameter":"test_parameter","value":42},)"
          R"({"timestamp":"1970-01-01T00:00:00.000000Z","tag":"updateItemInstanceAlert","item":{"id":"itemID"},)"
          R"("subject":{"id":"subjectID"},"instance":1,"version":"1.0.0",)"
          R"("message":"Test service instance alert message"},)"
          R"({"timestamp":"1970-01-01T00:00:00.000000Z","tag":"systemAlert","node":{"codename":"test_node"},)"
          R"("message":"Test system alert message"},)"
          R"({"timestamp":"1970-01-01T00:00:00.000000Z","tag":"systemQuotaAlert","node":{"codename":"test_node"},)"
