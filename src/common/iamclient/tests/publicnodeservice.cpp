...
class TestablePublicNodesService : public PublicNodesService {
public:
...
protected:
    void SetUp() override
    {
        ...
        mService = std::make_unique<TestablePublicNodesService>();
    ...
    std::unique_ptr<IAMPublicNodesServiceStub>  mStub;
    std::unique_ptr<TestablePublicNodesService> mService;
    TLSCredentialsMock                          mTLSCredentialsMock;
};
